...
const PrivacyPolicy = () => {
  return (
    <section className="w-screen flex flex-col items-center">
      <section className="md:w-[60%] w-[85%] flex flex-col justify-around">
        ...
        <h2 className="text-3xl bold">Definitions</h2>
        <div className="p-3">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to warofmind.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to warofmind, accessible from{" "}
                <a
                  href="https://sales.warofmind.com"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://sales.warofmind.com
                </a>
              </p>
            </li>
            <li>
        ...
        <div className="p-2">
          <h2 className="text-2xl bold">Types of Data Collected</h2>
          <div className="p-2">
        ...
        <h2 className="text-2x">Transfer of Your Personal Data</h2>
        <div className="p-2">
          <p>
        ...
        <h2 className="text-2x">Delete Your Personal Data</h2>
        <div className="p-2">
          <p>
        ...
        <div className="p-2">
          <h3 className="text-xl">Business Transactions</h3>
          <div className="p-2">
            <p>
        ...
        <h1 className="text-3xl">Children's Privacy</h1>
        <div className="p-2">
          <p>
        ...
        <div className="p-1">
          ...
          <ul>
            <li>By email: wyzbits@gmail.com</li>
          </ul>
        </div>
      </section>
    </section>
